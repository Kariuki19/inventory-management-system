...
import '../../reports/widgets/report_download_sheet.dart';
...
class _TrialCountdownBannerState extends State<_TrialCountdownBanner> {
  ...
  Widget build(BuildContext context) {
    ...
    final textColor =
        isWarning ? const Color(0xFFFF4D4D) : const Color(0xFFFF6B00);
                  ...
                  return Scrollbar(
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final statusText =
                            CustomDateUtils.DateUtils.formatExpiryStatus(
                                daysUntilExpiry);
  ...
  Widget _buildStockStatusBreakdown() {
    return StreamBuilder<Map<String, dynamic>>(
      ...
      builder: (context, snapshot) {
        ...
        final maxValue =
            values.reduce((a, b) => a > b ? a : b).clamp(1, totalItems);
  ...
  Widget _buildCategoryPieChart() {
    return StreamBuilder<Map<String, int>>(
      ...
      builder: (context, snapshot) {
        ...
        final values = categoryStats.values.map((v) => v.toDouble()).toList();
        ...
        return BarChart(
          BarChartData(
            ...
            barTouchData: BarTouchData(
              ...
              touchTooltipData: BarTouchTooltipData(
                getTooltipItem: (group, groupIndex, rod, rodIndex) {
                  final percentage = ((values[groupIndex] / totalItems) * 100).toInt();
                  return BarTooltipItem(
